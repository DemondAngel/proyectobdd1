...
/*
a.
 Determinar el total de las ventas de los productos con la categor�a que se proveade argumento de entrada en la consulta,para cada uno de los territorios registradosen la base de datos.
 * */
...
/*
b. Determinar el producto m�s solicitado para la regi�n (atributo group de salesterritory)�Noth America�y en que territorio de la regi�n tiene mayordemanda.Quitando el Top 1, da la lista de todos los productos
 * */
...
/* c. Actualizar el stock disponible en un 5% de los productos de la categor�a que se  provea como argumento de entrada en una localidad que se provea como entrada en 
...
/*
f.  Actualizar el m�todo de env�o de una orden que se reciba como argumento en la instrucci�n de actualizaci�n.  NOTA: Lista todas las ordenenes dependiendo el metodo de envio
 */	
...
/*
 g Actualizar el correo electr�nico de una cliente que se reciba como argumento en la instrucci�n de actualizaci�n. NOTA: Lista a la persona y su correElectronico, parametrizar por correo electronico, en lugar de BusinessEntityID
 */
