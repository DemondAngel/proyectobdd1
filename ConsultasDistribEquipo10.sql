...
begin 
	SELECT soh.TerritoryID, SUM(Tabla.lineTotal) as total_Ventas FROM  SALESAW.salesAW.Sales.SalesOrderHeader soh
inner join
...
FROM  SALESAW.SalesAW.Sales.Customer scus inner join 
 SALESAW.SalesAW.Sales.SalesOrderHeader soh on scus.CustomerID != soh.CustomerID
