            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(Var1, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(28, 28, 28)
                        .addComponent(TiVar2)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
        ...
        */
        ...
        switch (ListaConsultas.getSelectedIndex()){
            case 0:
                ...
                TiVar2.setText(""); 
                Var1.setText("1");
                Descripcion.setText("<html>Determina el total de ventas de los productos para cada<br> territorio de acuerdo a la categoría solicitada</html>");
                Var2.enable(false);
                F=0;
            break;
            case 1:
                ...
                TiVar2.setText("");
                Var1.setText("");
                Descripcion.setText("<html>Determinar el producto más solicitado para la región<br> (atributo group de salesterritory)“Noth America”y en<br> que territorio de la región tiene mayor demanda.</html>");
                Var2.enable(false);
                F=1;
            break;
            case 2:
                ...
                TiVar2.setText("");
                Var1.setText("1");
                Descripcion.setText("<html>Actualizar el stock disponibleen un 5%delos productos de la <br>categoría que se provea como argumento de entradaen una<br> localidad que se provea como entrada en la instrucción de actualización</html>");
                Var2.enable(false);
                F=2;
            break;
            case 3:
                TiVar1.setText("");
                TiVar2.setText("");
                Descripcion.setText("<html>Determinar si hay clientes que realizan ordenes en territorios<br> diferentes al que se encuentran. ");
                Var1.enable(false);
                Var2.enable(false);
                F=3;
            break;
            case 4:
                ...
                Var1.setText("1");
                Var2.setText("1");
                Descripcion.setText("<html>Actualizar  la  cantidad  de  productos  de  una  ordenque<br>  seprovea  como argumento en la instrucción de actualización.</html>");
                F=4;
            break;
            case 5:
                TiVar1.setText("ID Orden (dígito):");
                ...
                Var1.setText("1");
                Var2.setText("1");
                Descripcion.setText("<html>Actualizar el métodode envío de una orden que se<br> reciba como argumento en la instrucción de actualización.</html>"); 
                F=5;
            break;
            case 6:
                ...
                Var1.setText("");
                Var2.setText("");
                Descripcion.setText("<html>Actualizar el correo electrónico de una cliente que se reciba como<br>  argumento en la instrucción de actualización.</html>");
                F=6;
            break;
        }
    ...
    private void ConsultarMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_ConsultarMouseClicked
        ...
        */
        ...
        switch (F){
            ...
            break;
            case 3:
                JOptionPane.showMessageDialog(rootPane, "Actualización realizada con éxito","Confirmación",JOptionPane.CLOSED_OPTION);
